...
function Banner() {
    const bgImage = "https://res.cloudinary.com/dmzjba3cu/image/upload/v1714371055/samples/landscapes/beach-boat.jpg";
    return (
            ...
            <div className='max-w-6xl mx-auto flex justify-between h-full  '>
                <div className='flex flex-col   justify-around w-1/2 '>
                    <div className=' text-white '>
                        <h1 className='text-4xl font-bold mb-4'>Effortless Travel Planning! Let AI Be Your Expert Guide.</h1>
                    ...
                    <div className='flex gap-16'>
                        <div className='w-32 flex flex-col items-center'>
                            ...
                            <p className='font-semibold text-white text-center '>Free Personalized
                                Itineraries</p>
                        </div>
                        <div className='w-32 flex flex-col items-center'>
                ...
                <div className='bg-white bg-opacity-75 shadow-sm  w-[450px] text-black h-[460px] p-2 pl-4 pr-4 mt-10 rounded-md'>
                    ...
                    <div className='flex flex-col gap-4 '>
                        ...
                        <div className='text-black flex gap-2 '>
                            ...
                            <p className='text-sm'>Not sure? Let us decide best time for your trip.</p>
                        </div>
