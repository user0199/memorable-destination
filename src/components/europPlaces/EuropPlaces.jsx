      ...
      return (
        <div className='max-w-6xl mx-auto p-4'>
          ...
          <div className='text-center'>
            <button className='p-2 pr-4 pl-4  border border-black rounded-xl hover:bg-black hover:text-white transition-all duration-300 ease-in-out font-semibold'>Start your journey to Europ now!</button>
          </div>
        </div>
