...
function DwarkaAndSomnath() {
    const DwarkaData = constants.data.find(item => item.Place === "Dwarka and Somnath");
    const { Place, bannerContent, bannerimage, details,price,days } = DwarkaData || {};
...
export default DwarkaAndSomnath;
