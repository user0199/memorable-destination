...
function LehLaddakh() {
    const LaddakhData = constants.data.find(item => item.Place === "Leh-Ladakh");
    const { Place, bannerContent, bannerimage, details ,price,days } = LaddakhData || {};
